...
name_mapping = {
    ...
    'quizx-clifford-simplified-gates': 'simplificação de clifford  ket',
    'pyzx-clifford-simplified-gates': 'simplificação de clifford pyzx',
    # 'pyzx-teleport-reduced-gates': 'simplificação de teleporte pyzx',
...
plt.savefig("/tmp/gates.svg", transparent=True)
